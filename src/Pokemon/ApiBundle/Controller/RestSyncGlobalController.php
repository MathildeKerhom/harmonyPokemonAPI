...
class RestSyncGlobalController extends Controller {
    ...
    public function generateHashAction(Request $request)
    {
        ...
        $this->generateHashForEntity($entityManager, 'PokemonApiBundle:Npc');
        ...
        $this->generateHashForEntity($entityManager, 'PokemonApiBundle:NpctoBadges');
        ...
        $this->generateHashForEntity($entityManager, 'PokemonApiBundle:TypeObjet');
